...
| `TAILSCALE_USE_TAGS`    | Set the tags to assign for applying ACL's etc. to the container. See [here](https://tailscale.com/docs/features/tags) for more details on tags and how to use them                                                                                                                                           | `tag:docker`                             |
